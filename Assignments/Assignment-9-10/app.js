...
// Green Move now
 ...
 //var colorofroadTrafficSignal = prompt("Enter the color of signal light:");
...
// if (colorofroadTrafficSignal== "red"){
 ...
 //}
 //else (colorofroadTrafficSignal== "green")
 //{
...
//Run this script, & check whether alert message would bedisplayed or not. Record the outputs.
//a. var a = 4;
//if (++a === 5){
